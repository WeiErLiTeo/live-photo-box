...
### 📦 便携版 / Portable
[⬇️ **Live-Photo-Box-v2.0.2-x64-portable.zip**](https://github.com/LengxiQwQ/live-photo-box/releases/download/v2.0.2/Live-Photo-Box-v2.0.2-x64-portable.zip)

### ⚙️ 安装版 / Installer
[⬇️ **Live-Photo-Box-v2.0.2-x64-setup.exe**](https://github.com/LengxiQwQ/live-photo-box/releases/download/v2.0.2/Live-Photo-Box-v2.0.2-x64-setup.exe)
