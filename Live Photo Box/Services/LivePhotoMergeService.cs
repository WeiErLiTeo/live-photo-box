...
namespace LivePhotoBox.Services
{
    ...
    public static class LivePhotoMergeService
    {
        ...
        internal static async Task<int> DetectVideoFrameCountAsync(string videoPath, CancellationToken token)
        {
            try
            {
        ...
        internal static byte[] InsertTmapBrand(byte[] heicData)
        {
        ...
        /// </remarks>
        internal static long ReadSourceCoverTimestamp(string videoPath)
        {
            // ── Apple Live Photo ──
